...
print(f"   resolved in {time.perf_counter() - t0:.2f}s: "
...
print(f"   {len(turns)} turns in {elapsed:.2f}s, progress: "
...
for entry in aligned:
    print(f"   {entry['start']:7.2f} -- {entry['end']:7.2f}  "
...
job = {
    ...
    "language": None,
    "duration": 56.9,
    "opts": s.build_opts("base", "int8", "", "true", "balanced", "", "",
                         "false", "false", "false", 2000, 400, "true", 0),
    "segments": aligned,
}
